...
class Modeltempatkerja extends Model {
    
    protected $table = 'tempatkerja';
    protected $primaryKey = 'tempatkerja_id';
    ...
    {
        return $this->table('tempatkerja')
            ->orderBy('tempatkerja_id', 'ASC')
            ->get()->getResultArray();
    }
