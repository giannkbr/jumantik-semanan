...
<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('tempatkerja/simpan', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
    ...
    $(document).ready(function() {
        ...
        $('.formtambah').submit(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    nama_tempat: $('input#nama_tempat').val(),
                    alamat_tempat: $('input#alamat_tempat').val(),
                    tanggal: $('input#tanggal').val(),
                    dispenser: $('select#dispenser').val(),
                    bak_mandi : $('select#bak_mandi').val(),
                    kolam_ikan : $('select#kolam_ikan').val(),
                    cucian_piring : $('select#cucian_piring').val(),
                    pot_tanaman : $('select#pot_tanaman').val(),
                },
                dataType: "json",
                beforeSend: function() {
