...
<div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <?= form_open('warga/simpantetangga', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="form-group row">
                    <label for="" class="col-sm-4 col-form-label">Nama Rukun Warga</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_tetangga" name="nama_tetangga">
    ...
    $(document).ready(function() {
        ...
        $('.formtambah').submit(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    nama_tetangga: $('input#nama_tetangga').val(),
                },
                dataType: "json",
                beforeSend: function() {
