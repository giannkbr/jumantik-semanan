...
$routes->get('/auth/warga/tetangga', 'Warga::tetangga', ['filter' => 'Validasilogin']);
$routes->get('/auth/warga', 'Warga::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/pendidikan', 'Pendidikan::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/umum', 'Umum::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/olahraga', 'Olahraga::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/makanan', 'Makanan::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/kesehatan', 'Kesehatan::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/rumahtangga', 'Rumahtangga::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/tempatkerja', 'Tempatkerja::index', ['filter' => 'Validasilogin']);
$routes->get('/auth/master', 'Master::index', ['filter' => 'Validasilogin']);
/**
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
