...
class BaseController extends Controller
{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->tetangga = new Modeltetangga;
		$this->warga = new Modelwarga;
		$this->pendidikan = new Modelpendidikan;
		$this->umum = new Modelumum;
		$this->olahraga = new Modelolahraga;
		$this->kesehatan = new Modelkesehatan;
		$this->makanan = new Modelmakanan;
		$this->rumahtangga = new Modelrumahtangga;
		$this->tempatkerja = new Modeltempatkerja;
